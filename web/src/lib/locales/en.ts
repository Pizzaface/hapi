export default {
  ...
  'team.create': '+ Team',
  'team.create.placeholder': 'Team name',
  'team.create.submit': 'Create',
  'team.create.creating': 'Creating…',
  'team.create.error': 'Failed to create team',
  'team.menu.rename': 'Rename',
  'team.menu.changeColor': 'Change color',
  'team.menu.delete': 'Delete team',
  'team.rename.title': 'Rename Team',
  'team.rename.placeholder': 'Team name',
  'team.rename.error': 'Failed to rename team',
  'team.color.title': 'Team Color',
  'team.color.noColor': 'Default',
  'team.color.error': 'Failed to update color',
  'team.delete.title': 'Delete Team',
  'team.delete.description': 'Delete "{name}"? Sessions will be ungrouped but not deleted.',
  'team.delete.confirm': 'Delete',
  'team.delete.confirming': 'Deleting…',
  ...
  'session.dragHandle.label': 'Reorder session "{name}"',
  'session.dragHandle.instructions': 'Press Enter to pick up, arrow keys to move, Enter to drop.',
  'session.dragHandle.disabled': 'Reordering is disabled in selection mode.',
  'session.status.thinking': 'thinking',
  'session.status.idle': 'idle',
  'session.status.needsInput': 'needs input',
  ...
  'newSession.persona.none': 'None',
  'newSession.persona.none.desc': 'Use Claude default behavior',
  ...
  'settings.teams.displayStyle': 'Team display style',
  'settings.teams.style.card': 'Card',
  'settings.teams.style.leftBorder': 'Left Border',
  'settings.notifications.title': 'Notifications',
  'settings.notifications.readyIdle': 'Ready / Idle',
  'settings.notifications.permissionPrompts': 'Permission Prompts',
  'settings.notifications.errorNotifications': 'Error Notifications',
  'settings.notifications.errorNotifications.comingSoon': 'Coming soon',
  'settings.notifications.allDisabledWarning': 'All notifications are off. You may miss important events.',
